...
parser.add_argument('--consistency_rampup', type=float,
                    default=20.0, help='consistency_rampup')
args = parser.parse_args()


def patients_to_slices(dataset, patiens_num):
    if "LiTS" in dataset or "ACDC" in dataset:
        ref_dict = {"3": 68, "7": 136, "14": 256, "21": 396, "28": 512, "35": 664, "140": 1312, "150": 25000}
...
def train(args, snapshot_path):
    ...
    batch_sampler = TwoStreamBatchSampler(
        labeled_idxs, unlabeled_idxs, batch_size, args.labeled_bs)
    ...
    for epoch_num in iterator:
        for i_batch, sampled_batch in enumerate(trainloader):
            ...
            mlflow.log_metric('consistency_loss', consistency_loss.item(), step=iter_num)
            ...
            if iter_num > 0 and iter_num % 200 == 0:
                ...
                for i_batch, sampled_batch in enumerate(valloader):
                    ...
                    if metric_i is not None and not any(m is None for m in metric_i):
            ...
            if iter_num % 3000 == 0:
                ...
                # Log periodic checkpoint as MLflow artifact
                mlflow.log_artifact(save_mode_path)
...
if __name__ == "__main__":
    with mlflow.start_run(run_name=args.exp):
        ...
        snapshot_path = "/home/sc.uni-leipzig.de/mj49xire/model/{}_{}_labeled_new2/{}".format(
